		...
		<div class="collapse navbar-collapse" id="myNavbar">
			<ul class="list-inline">
				<li><a class="languageEN current"
					href="${pageContext.request.contextPath}/updateproject?lang=en&id=${id}"
					class="black-link">EN</a> | <a class="language"
					href="${pageContext.request.contextPath}/updateproject?lang=fr&id=${id}">FR</a></li>
				<li></li>
				<li></li>
	...
	<div class="container-fluid text-center">
		<div class="row content">
			...
			<div class="col-sm-7 text-left">
				<h3>
					<spring:message code="menu.updateproject" />${message}</h3>
				<hr>

				<form:form class="formNew" method="POST"
					modelAttribute="updateprojectForm">
					<div class="form-group row ">
						...
						<div class="col-sm-4">
							<form:input type="text" path="projectNumber" class="form-control"
								cssErrorClass="form-control has-error" id="projectNumberUp"
								name="projectNumberUp" readonly="true"></form:input>
					...
					<div class="form-group row">
						...
						<div class="col-sm-10">
							...
							<form:input type="text" path="customer" class="form-control"
								cssErrorClass="form-control has-error" id="customer"></form:input>
					...
					<div class="form-group row">
						<div class="col-sm-6 btn-float-left">
							...
							<button type="submit" class="btn btn-primary ">
								<spring:message code="btn.update" />${message}</button>
						</div>
					</div>
				</form:form>
			</div>
